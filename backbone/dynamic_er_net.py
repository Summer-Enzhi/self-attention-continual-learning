...
class DERNet(nn.Module):
    ...
    def update_fc(self, nb_classes):
        ...
        if len(self.feature_extractor)==0:
            ...
            self.feature_extractor.append(ft)
            self.feature_extractor[-1].load_state_dict(self.feature_extractor[0].state_dict())
        
        self.aux_fc=self.generate_fc(self._feature_dim, new_task_size)
            
        fc = self.generate_fc(self._feature_dim*len(self.feature_extractor), new_task_size)
