...
os.environ['DATA']='/mnt/newspace/wangenzhi_space/data'

#tensorboard --logdir "/mnt/userspace/wangenzhi_space/cl_pytorch_transfer/CL_Pytorch-main/logs/multi_step/acl_til_replay_herding/ar/resnet18_b1i10" --bind_all
def set_random(seed):
